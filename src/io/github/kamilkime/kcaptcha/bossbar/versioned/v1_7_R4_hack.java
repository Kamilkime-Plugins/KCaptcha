...
public class v1_7_R4_hack extends KBoss {

	public v1_7_R4_hack(String name, Location location, float startPercent, Object color, Object style, BossType bossType) {
	...
	public void sendTeleportPacket(Player p, Location to) {
		sendPacket(p, ReflectionUtils.getConstructor("net.minecraft.server.v1_7_R4.PacketPlayOutEntityTeleport", int.class, int.class, int.class, int.class, byte.class,
				byte.class, boolean.class, boolean.class).invoke(((Entity) this.boss).getId(), (int) (to.getX() * 32.0D), (int) (to.getY() * 32.0D),
				(int) (to.getZ() * 32.0D), ((byte)(int)(to.getYaw() * 256.0F / 360.0F)), ((byte)(int)(to.getPitch() * 256.0F / 360.0F)), false, false));
	}
