...
public class FileDataManager{
	...
	public static File ipFile = new File(mainDir, "ips.yml");
	...
	public static YamlConfiguration getIpFile(){
		return YamlConfiguration.loadConfiguration(ipFile);
}
